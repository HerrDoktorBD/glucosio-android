...
public class ExternalViewPresenterTest extends RobolectricTest {
    ...
    @Test
    public void shouldLoadOpenSourceLicensesWhenLicenseParameters() throws Exception {
    ...
    @Test
    public void shouldInvokeShowNoConnectionWarningWhenNetworkIsNotConnected() throws Exception {
